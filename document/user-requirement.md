...
7. [UseCase Diagram](#7-usecase-diagram)
...
![ Luồng hoàn tiền](<../image/learnOw.drawio%20(2).svg>)

## 8. Luồng nghiệp vụ chính

![Luồng nghiệp vụ chính ](../image/flow1.jpg)

### 8.2 Luồng tạo & Duyệt khóa học

![Luồng nghiệp vụ chính ](../image/flow2.jpg)

### 8.3 Luồng đăng ký giảng viên
...
### 9.2 Tiêu chí thẩm định khóa học
...
### 10.1 Trạng thái các entity chính
...
### 10.2 Lịch sử thay đổi tài liệu
